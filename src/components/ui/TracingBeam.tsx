...
export const TracingBeam = ({
    ...
    return (
        <motion.div
            ref={ref}
            className={cn("relative w-full max-w-screen-3xl mx-auto h-full", className)}
        >
                    ...
                    <>
                        ...
                        >
                            <motion.div
                                ...
                                animate={{
                                    backgroundColor:
                                        scrollYProgress.get() > 0 ? "white" : "var(--cyan-500)",
                                    borderColor:
                                        scrollYProgress.get() > 0 ? "white" : "var(--cyan-600)",
                                }}
