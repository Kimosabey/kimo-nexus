        ...
        <section ref={heroRef} className="relative w-full min-h-screen flex items-center justify-center overflow-hidden py-10 xs:py-20 lg:py-0" id="hero">
          <div className="max-w-7xl w-full mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center relative" style={{ perspective: '1200px' }}>
            ...
            >
              ...
              >
                <div className="text-base md:text-2xl 3xl:text-4xl font-display text-gray-400 mb-6 h-auto md:h-12 flex flex-col md:flex-row items-center justify-center lg:justify-start gap-1 md:gap-3">
                  <span className="opacity-50 font-mono text-[10px] md:text-sm 3xl:text-lg tracking-wider xs:tracking-widest text-[#6b7bff]">DESCRIPTOR//:</span>
                ...
                <p
                  className="text-base md:text-lg lg:text-xl 3xl:text-3xl text-gray-400 max-w-xl 3xl:max-w-4xl mx-auto lg:mx-0 leading-relaxed font-light mb-10"
                ...
                <div className="flex flex-col sm:flex-row gap-6 mt-2 justify-center lg:justify-start">
                  <MovingBorderButton
                    ...
                    className="bg-[#050505] text-white border-white/10 font-mono text-[9px] xs:text-xs md:text-sm 3xl:text-2xl font-black tracking-[0.2em] xs:tracking-[0.3em] px-6 xs:px-10 md:px-12 3xl:px-20 py-4 xs:py-5 md:py-6 3xl:py-10 hover:bg-cyan-500/10 transition-colors uppercase shadow-2xl"
                  >
                    EXPLORE_SUBSYSTEMS
                  </MovingBorderButton>
                </div>
            ...
            <section className="w-full pt-12 md:pt-16" id="about">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 xs:gap-4 mt-8 xs:mt-12">
                    {[
                      { label: "EXPERIENCE_METRIC", val: "4.8 YRS", desc: "Full Stack & AI Core" },
                      { label: "SYSTEM_DELIVERY", val: "40+", desc: "Deployed Platforms" },
                    ].map((stat, i) => (
                      <div key={i} className="group/stat p-4 xs:p-8 md:p-10 3xl:p-16 rounded-[2rem] xs:rounded-[2.5rem] 3xl:rounded-[4rem] bg-white/[0.02] border border-white/5 hover:border-cyan-400/40 transition-all duration-700 backdrop-blur-xl relative overflow-hidden">
                        ...
                        <div className="text-3xl xs:text-4xl md:text-6xl 3xl:text-8xl font-black text-white mb-3 relative z-10 font-display tracking-tight group-hover/stat:text-cyan-400 transition-colors">{stat.val}</div>
                        <div className="text-[9px] xs:text-[11px] 3xl:text-xl text-cyan-400/60 uppercase tracking-[0.4em] font-black mb-1 relative z-10 group-hover/stat:text-cyan-400 transition-colors text-shadow-glow">{stat.label}</div>
                        <div className="text-[10px] xs:text-xs md:text-sm 3xl:text-lg text-gray-400 relative z-10 italic font-light tracking-wide">{stat.desc}</div>
                ...
                <div className="relative group lg:pl-12">
                  <div className="flex items-center justify-center w-full min-h-[20rem] md:min-h-[25rem]">
                    <PinContainer title="/system.core" href="#projects">
                      <div className="flex basis-full flex-col p-4 tracking-tight text-slate-100/50 sm:basis-1/2 w-[17rem] xs:w-[20rem] md:w-[24rem] h-auto min-h-[18rem] md:min-h-[20rem]">
                        <div className="flex flex-col justify-center h-full">
                          ...
                          <div className="pt-6 border-t border-blue-500/10">
                            <TextGenerateEffect words="// Harmonizing machine intelligence with human-scale precision." className="text-gray-400 font-light text-xs" />
                          </div>
                        </div>
                      </div>
                    </PinContainer>
                      ...
                      <CardBody className="bg-[#050505]/40 relative group/card-body border-white/10 w-full h-auto rounded-[1.8rem] md:rounded-[3.5rem] p-3 xs:p-4 md:p-8 border hover:border-cyan-400/50 transition-all duration-700 shadow-3xl overflow-hidden backdrop-blur-md">
                        ...
                        <div className="flex justify-between items-center mt-12 pt-8 border-t border-white/5 mx-[-2rem] px-8">
                          {project.isProprietary ? (
                            <div className="w-full flex items-center justify-center gap-4 py-5 rounded-[1.8rem] bg-white/[0.03] border border-white/5 text-gray-300 text-[9px] xs:text-[10px] font-black uppercase tracking-[0.4em] transition-all group-hover:bg-white/[0.08] cursor-not-allowed">
                            ...
                            <CardItem
                              ...
                              target="__blank"
                              className="w-full flex items-center justify-center gap-3 xs:gap-5 py-4 xs:py-5 rounded-[1.2rem] xs:rounded-[1.8rem] bg-white text-black text-[10px] xs:text-[11px] font-black hover:bg-cyan-400 hover:shadow-[0_0_50px_rgba(0,212,255,0.4)] transition-all uppercase tracking-[0.2em] xs:tracking-[0.4em] group/link shadow-xl"
                            >
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16 py-20 border-t border-white/10 relative z-10">
                      ...
                      <ul className="space-y-4">
                        {[
                          ...
                          <motion.li
                            ...
                            className="text-[11px] 3xl:text-sm font-mono text-gray-300 hover:opacity-100 transition-opacity flex items-center gap-3 uppercase cursor-default"
                          >
                    ...
                    <div className="space-y-8">
                      ...
                      <div className="flex flex-wrap xs:flex-nowrap gap-4 3xl:gap-8 justify-center xs:justify-start">
                        {[
                          { id: 1, url: "https://github.com/HarshanAiyappaPrabhu", icon: <Github size={24} className="xs:w-6 xs:h-6 3xl:w-10 3xl:h-10" /> },
                          { id: 2, url: "https://www.linkedin.com/in/harshan-aiyappa-prabhu/", icon: <Linkedin size={24} className="xs:w-6 xs:h-6 3xl:w-10 3xl:h-10" /> },
                          { id: 3, url: "https://twitter.com/HarshanAiyappa", icon: <Twitter size={24} className="xs:w-6 xs:h-6 3xl:w-10 3xl:h-10" /> },
                        ].map((social) => (
                          <motion.a
                            key={social.id}
                            ...
                            href={social.url}
                            target="_blank"
                            className="w-12 h-12 xs:w-14 xs:h-14 3xl:w-24 3xl:h-24 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-gray-300 hover:text-purple-400 hover:border-purple-400/30 transition-all backdrop-blur-xl"
                          >
                            {social.icon}
                          </motion.a>
                        ))}
                  ...
                  <div className="flex flex-col lg:flex-row items-center justify-between gap-12 pt-16 border-t border-white/5 relative z-10 w-full">
                    <div className="flex flex-col items-center lg:items-start gap-2">
                      <p className="text-[10px] 3xl:text-lg font-mono text-gray-500 tracking-[0.4em] uppercase font-bold">System_Runtime_V5.0 // Sentinel_Secure</p>
