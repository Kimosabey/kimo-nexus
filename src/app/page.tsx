      ...
      <main className="relative z-10 flex flex-col items-center w-full bg-[#050505] overflow-x-hidden">
        ...
        <section ref={heroRef} className="min-h-[100dvh] w-full flex flex-col justify-center items-center px-6 md:px-12 lg:px-24 3xl:px-40 pt-32 lg:pt-24 pb-16 md:pb-24 relative overflow-hidden z-10 max-w-[2560px] mx-auto">
          ...
          */}
            ...
            <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden py-20 lg:py-0" id="hero">
              <div className="max-w-7xl w-full mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center relative" style={{ perspective: '1200px' }}>
                ...
                >
                  ...
                  <div style={{ transform: 'translateZ(30px)' }}>
                    <TextGenerateEffect
                      words="ARCHITECTING"
                      className="text-[2rem] sm:text-6xl md:text-7xl lg:text-8xl xl:text-8xl 2xl:text-[7rem] 3xl:text-[9rem] font-black tracking-tighter text-white leading-[0.95] uppercase text-center lg:text-left"
                      duration={0.8}
                      filter={true}
                    />
                    <TextGenerateEffect
                      words="DIGITAL MINDS"
                      className="text-[2rem] sm:text-6xl md:text-7xl lg:text-8xl xl:text-8xl 2xl:text-[7rem] 3xl:text-[9rem] font-black tracking-tighter leading-[0.95] uppercase text-center lg:text-left bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 via-white to-teal-400"
                      duration={0.8}
                      filter={true}
                    />
                  </div>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 xs:gap-4 mt-8 xs:mt-12">
                        {[
                          ...
                          <div key={i} className="group/stat p-6 xs:p-8 md:p-10 3xl:p-16 rounded-[2rem] xs:rounded-[2.5rem] 3xl:rounded-[4rem] bg-white/[0.02] border border-white/5 hover:border-cyan-400/40 transition-all duration-700 backdrop-blur-xl relative overflow-hidden">
                            ...
                            <div className="text-[10px] xs:text-xs md:text-sm 3xl:text-lg text-gray-500 relative z-10 italic font-light tracking-wide">{stat.desc}</div>
                    ...
                    {projects.map((project) => (
                      ...
                      >
                        <CardContainer className="inter-var group/card w-full">
                          <CardBody className="bg-[#050505]/40 relative group/card-body border-white/10 w-full h-auto rounded-[1.8rem] md:rounded-[3.5rem] p-4 xs:p-6 md:p-8 border hover:border-cyan-400/50 transition-all duration-700 shadow-3xl overflow-hidden backdrop-blur-md">
                            ...
                            <CardItem as="p" translateZ="90" className="text-gray-400 text-[11px] xs:text-sm md:text-base mt-2 xs:mt-4 font-light leading-relaxed uppercase tracking-tight">{project.description}</CardItem>
                            ...
                            <div className="flex justify-between items-center mt-12 pt-8 border-t border-white/5 mx-[-2rem] px-8">
                              {project.isProprietary ? (
                                <div className="w-full flex items-center justify-center gap-4 py-5 rounded-[1.8rem] bg-white/[0.03] border border-white/5 text-gray-400 text-[9px] xs:text-[10px] font-black uppercase tracking-[0.4em] transition-all group-hover:bg-white/[0.08] cursor-not-allowed">
