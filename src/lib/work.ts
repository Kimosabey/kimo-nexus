...
const P: Row[] = [
  ...
  ["route-master", "RouteMaster", "AI Cost Routing", "AI · Agents", "Cost-optimized LLM router that scores each prompt's complexity and routes to the cheapest capable model, with measured savings.", ["TypeScript", "Node.js", "LLM", "Docker"], "repo", "https://github.com/Kimosabey/route-master", true],
  ["driftwatch-pro", "DriftWatch Pro", "MLOps · Drift", "Data", "Statistical data-drift detection with a two-sample KS-test and PSI, per-feature baselines, and severity-graded alerts.", ["Python", "NumPy", "MLOps", "Docker"], "repo", "https://github.com/Kimosabey/driftwatch-pro", true],
  ["event-replay", "EventReplay", "Event Sourcing", "Distributed", "Event-sourced state reconstruction with deterministic replay, time-travel to any sequence, and snapshots.", ["TypeScript", "Node.js", "Event Sourcing", "Docker"], "repo", "https://github.com/Kimosabey/event-replay", true],
  ["chrono-sync", "ChronoSync", "Distributed Time", "Distributed", "Vector clocks in Rust for distributed causal ordering — detects happens-before and truly concurrent events.", ["Rust", "Vector Clocks", "Distributed Systems"], "repo", "https://github.com/Kimosabey/chrono-sync", true],
  ...
  ["zeus-biotech", "Zeus Biotech", "Enterprise Platform", "Web · Product", "Full-stack biotech ops platform — Next.js web admin, React Native mobile, Node.js REST API, and MSSQL — unifying orders, distributors, and internal workflows.", ["Next.js", "React Native", "Node.js", "MSSQL"], "prop", "", false],
